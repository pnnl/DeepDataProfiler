...
if __name__ == '__main__':
    ...
    df_dir = "../datasets/cifar10_full_bg_5_df/"
    
    print("collection activations for", layer)
    
    
    layer_activations_df = pd.read_csv(df_dir+"train_full_bg_5_"+layer+".csv")
    ...
    output_dir = '../mapper_graphs/full_bg_5/'
    output_fname = 'full_bg_5_'+layer
