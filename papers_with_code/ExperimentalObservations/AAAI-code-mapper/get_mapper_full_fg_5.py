...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul 13 07:30:44 2021
...
if __name__ == '__main__':
    ...
    df_dir = "../datasets/cifar10_full_fg_5_df/"
    
    print("collection activations for", layer)
    
    layer_activations_df = pd.read_csv(df_dir+"train_full_fg_5_"+layer+".csv")
    ...
    output_dir = '../mapper_graphs/full_fg_5/'
    output_fname = 'full_fg_5_'+layer
