...
# -*- coding: utf-8 -*-
"""
Created on Tue Sep 21 02:34:51 2021
...
if __name__ == '__main__':
    ...
    df_dir = "../datasets/cifar10_full_fg_1_df_noises/"
    ...
    layer_activations_df = pd.read_csv(df_dir+"train_full_fg_1_"+layer+"_"+str(sigma)+".csv")
    ...
    # print(df_mean.shape)
    # plt.hist(df_std)
    # plt.savefig('../figs/activations_std_fg1.png')
    # plt.close()
    # plt.hist(df_mean)
    # plt.savefig('../figs/activations_mean_fg1.png')
    # plt.close()
    ...
    output_dir = '../mapper_graphs/full_fg_1_noises/'
